...
class MainForm(Tk):
    def __init__(self, engine:str, login:str, pswd:str, host:str, port:str, database:str, dbschema:str):
        ...
        self.lbl_head = Label(self.f_head, text="Интерфейс для работы с базой данных Группы-Студенты\nВыберите пользователя", font=font1, background="#1F7C65", foreground="#9B001C")
        self.lbl_head.pack(side=LEFT, expand=1, fill=X)

        self.btn_goto_admin_form = Button(self.f_middle, text="Администратор", font=font2, background="#006C51", foreground="#FFB640")
        ...
        self.btn_goto_human_res_form = Button(self.f_middle, text="Сотрудник отдела кадров", font=font2, background="#006C51", foreground="#FFB640")
        ...
        self.btn_goto_dean_form = Button(self.f_middle, text="Сотрудник деканата", font=font2, background="#006C51", foreground="#FFB640")
        ...
        self.btn_goto_head_of_depart_form = Button(self.f_middle, text="Завкафедры", font=font2, background="#006C51", foreground="#FFB640")
